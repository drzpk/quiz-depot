...
/* WEBPACK VAR INJECTION */(function(global) {global.$ = __webpack_require__(15);
$(function () {
    var clock = $('#clock-value').get(0);
    window.clock = clock;

    // Uruchomienie zegara, jeśli istnieje
    if (window.seconds) window.clockTick();
});
...
window.clockTick = function () {
    ...
    if (window.seconds == 60) window.clock.style.color = 'red';else if (window.seconds == 300) window.clock.style.color = 'orange';
